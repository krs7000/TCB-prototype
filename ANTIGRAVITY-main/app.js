...
const mockNotifications = [
  { id: 1, icon: 'fa-circle-check', color: '#22c55e', title: 'PSU-PAT-2026-001 Approved', body: 'Your patent application has been certified.', time: '2 hours ago', read: false },
  { id: 2, icon: 'fa-file-circle-plus', color: '#f59e0b', title: 'Documents Requested', body: 'Admin Garcia requests additional docs for PSU-COP-2026-002.', time: 'Yesterday', read: false },
  { id: 3, icon: 'fa-circle-info', color: '#3b82f6', title: 'System Maintenance', body: 'Scheduled maintenance on April 10, 2026 from 2–4 AM.', time: '3 days ago', read: true }
];

// ===== MOCK DATA =====
let submissions = [
  { id: 'PSU-PAT-2026-001', type: 'Patent', title: 'Bamboo-Based Water Filtration Device', applicant: 'Maria Santos', department: 'College of Engineering', email: 'maria.santos@psu.edu.ph', contact: '09171234567', status: 'Approved', date: '2026-01-15', description: 'An innovative water filtration system using locally-sourced bamboo charcoal and natural minerals from Palawan.', field: 'Environmental Engineering', dateConceived: '2025-08-10' },
  { id: 'PSU-COP-2026-002', type: 'Copyright', title: 'PSU EcoLearn App', applicant: 'Juan dela Cruz', department: 'College of Sciences', email: 'juan.delacruz@psu.edu.ph', contact: '09181234567', status: 'Pending', date: '2026-02-20', description: 'A mobile learning application focused on environmental science education for Palawan communities.', workType: 'Software Application', dateCreated: '2025-11-05' },
  { id: 'PSU-TM-2026-003', type: 'Trademark', title: 'AquaGuard Brand Mark', applicant: 'Anna Reyes', department: 'Research Office', email: 'anna.reyes@psu.edu.ph', contact: '09191234567', status: 'Under Review', date: '2026-02-28', description: 'Brand identity for PSU\'s marine conservation research initiative.', markType: 'Logo & Word', goods: 'Research and educational services' },
  { id: 'PSU-PAT-2026-004', type: 'Patent', title: 'Solar-Powered Rice Dryer', applicant: 'Rodel Magtibay', department: 'College of Agriculture', email: 'rodel.magtibay@psu.edu.ph', contact: '09201234567', status: 'Rejected', date: '2026-03-01', description: 'A solar-powered mechanical dryer designed for small-scale rice farmers in Palawan.', field: 'Agricultural Engineering', dateConceived: '2025-06-15' },
  { id: 'PSU-COP-2026-005', type: 'Copyright', title: 'Heritage Palawan Cookbook', applicant: 'Liza Manalo', department: 'College of Arts', email: 'liza.manalo@psu.edu.ph', contact: '09211234567', status: 'Approved', date: '2026-01-10', description: 'A comprehensive cookbook documenting traditional Palawan recipes and culinary heritage.', workType: 'Literary Work', dateCreated: '2025-09-20' },
  { id: 'PSU-TM-2026-006', type: 'Trademark', title: 'Palawan Honey Brand', applicant: 'Dr. Elena Flores', department: 'College of Agriculture', email: 'elena.flores@psu.edu.ph', contact: '09221234567', status: 'Pending', date: '2026-03-10', description: 'Brand registration for organic honey products from PSU apiaries.', markType: 'Word', goods: 'Food products and agricultural goods' },
  { id: 'PSU-COP-2026-007', type: 'Copyright', title: 'MarineTrack Research Software', applicant: 'Dr. Ricardo Aquino', department: 'College of Sciences', email: 'ricardo.aquino@psu.edu.ph', contact: '09231234567', status: 'Under Review', date: '2026-03-15', description: 'Marine biodiversity tracking and data analysis software for underwater research.', workType: 'Software Application', dateCreated: '2025-12-01' },
  { id: 'PSU-PAT-2026-008', type: 'Patent', title: 'Coconut Shell Activated Carbon Filter', applicant: 'Prof. Carlos Reyes', department: 'College of Engineering', email: 'carlos.reyes@psu.edu.ph', contact: '09241234567', status: 'Pending', date: '2026-03-20', description: 'Advanced activated carbon filter using coconut shell waste for industrial water purification.', field: 'Chemical Engineering', dateConceived: '2025-10-25' },
  { id: 'PSU-UM-2026-009', type: 'Utility Model', title: 'Compact Folding Hand Tractor', applicant: 'Engr. Leo Hernandez', department: 'College of Agriculture', email: 'leo.hernandez@psu.edu.ph', contact: '09251234567', status: 'Under Review', date: '2026-03-25', description: 'A foldable hand tractor designed for easier transport in small-scale Palawan farms.', field: 'Agri-Machinery' },
  { id: 'PSU-ID-2026-010', type: 'Industrial Design', title: 'Tectonic Wave Furniture', applicant: 'Alice Torres', department: 'College of Arts', email: 'alice.torres@psu.edu.ph', contact: '09261234567', status: 'Awaiting Documents', date: '2026-03-28', description: 'Modern modular furniture inspired by Palawan coastline structures.', designType: 'Furniture Design' }
];
...
const marketplaceItems = [
  { 
    ...
    description: 'Advanced system for identifying and tracking unauthorized television signal connections natively within distributed networks.',
    longDescription: 'A wireless tool that can generate signal to Cable Television (CATV) distribution lines to detect or check if there are illegal cable connections.',
    features: [
    ...
    businessPotential: 'Illegal connections on CATV lines are rampant in the Philippines. One of the drawbacks is revenue loss to cable companies. The approximate amount of annual revenue loss is about 7 billion pesos or even more. This device helps cable companies penetrate the digital signal and stop violators.',
  ...
  { 
    ...
    description: 'Integrating a virtual nutritionist program to enhance automated body profiling and personalized diet mappings using AI.',
    longDescription: 'An AI-driven simulation platform designed to provide real-time nutritional analysis and personalized dietary recommendations based on individual health metrics.',
    features: [
    ...
    businessPotential: 'High demand in the health and wellness sector, particularly for remote patient monitoring and personalized fitness coaching. The system can be licensed to clinics and gym chains.',
  ...
  { 
    ...
    description: 'A utility model concerning the formulation and optimal mass production of nutritious lumpia wrappers infused with Moringa oleifera.',
    longDescription: 'A revolutionary food product that incorporates the nutritional benefits of Malunggay into a standard Filipino staple (Lumpia wrapper), enhancing vitamins and minerals without compromising texture.',
    features: [
    ...
    businessPotential: 'Targeting the healthy food market, which is seeing exponential growth in the Philippines. Can be packaged for both retail consumers and wholesale food establishments.',
  ...
  { 
    ...
    college: 'College of Engineering', 
    description: 'A rapid hardware-software mechanism to detect formalin contamination in fresh fish strictly utilizing optic scanning of the fish eye.',
    longDescription: 'A portable handheld device that uses advanced imaging to detect changes in the crystalline lens of the fish eye associated with formalin preservation.',
    features: [
    ...
    businessPotential: 'Essential for food safety inspectors and smart market consumers. Prevents the consumption of toxic chemicals in the fish supply chain.',
  ...
  { 
    ...
    inventor: 'R. Magtibay', 
    college: 'College of Arts', 
    description: 'An ergonomic and convertible aesthetic design for a multipurpose backpack tailored specifically for local market vendors.',
    longDescription: 'A modular bag system that converts from a heavy-duty backpack to a display stall or a lightweight hauler, optimized for the ergonomic needs of itinerant vendors.',
    features: [
    ...
    businessPotential: 'Can be manufactured as part of Livelihood development projects or sold directly to the large population of informal and formal vendors across Palawan.',
  ...
  { 
    ...
    inventor: 'A. Torres', 
    college: 'College of Engineering', 
    description: 'A distinct, visually appealing structural layout for an ultra-durable and rapidly deploying inflatable outdoor bed.',
    longDescription: 'An innovative outdoor furniture piece that uses ambient air pressure to inflate in under 30 seconds, designed for extreme durability in forest and beach conditions.',
    features: [
    ...
    businessPotential: 'High potential in the tourism and camping industry, particularly for eco-adventure tour operators in Palawan.',
  ...
  { 
    ...
    description: 'Official word-mark and brand logo registration for the Sargatek agricultural engineering cooperative.',
    longDescription: 'Comprehensive visual identity system for Sargatek, focusing on its core mission of integrating sustainable agricultural engineering with modern construction.',
    features: [
    ...
    businessPotential: 'The trademark protects the intellectual capital of the cooperative, ensuring market differentiation as it expands its services across Mimaropa region.',
  ...
  { 
    ...
    inventor: 'M. Santos', 
    college: 'College of Sciences', 
    description: 'Distinct stylized design and brand identifier for locally produced food supplements under the ISUY framework.',
    longDescription: 'A health-focused trademark that emphasizes the ethnic roots and natural sources of its supplement products.',
    features: [
    ...
    businessPotential: 'Protects the integrity of PSU-developed food supplements, allowing for commercial expansion and franchising without the risk of imitation.',
  ...
  { 
    ...
    college: 'College of Arts', 
    description: 'A comprehensive literary work outlining modernized legal office administrative procedures for academic institutions.',
    longDescription: 'A formalized written manual that serves as the definitive guide for legal administration within Palawan State University.',
    features: [
    ...
    businessPotential: 'Can be licensed to other State Universities and Colleges (SUCs) as a best-practice template for legal office management.',
  ...
  { 
    ...
    college: 'College of Sciences', 
    description: 'Software code and system architecture blueprint for Information, Permit, Application, Registration, and Clearance framework.',
    longDescription: 'A complex software solution that automates the entire lifecycle of student and faculty clearances and permit applications.',
    features: [
    ...
    businessPotential: 'Massive opportunity for Saas implementation within local government units and other higher education institutions looking to digitize their clearance workflows.',
  ...
  },
  {
    ...
    fullTitle: 'IOT-BASED ADAPTIVE SMART IRRIGATION CONTROLLER FOR SMALL-SCALE FARMS',
    type: 'Patent',
    inventor: 'Engr. R. Villanueva',
    college: 'College of Agriculture',
    description: 'An IoT-based irrigation controller that automatically adjusts watering schedules based on real-time soil moisture and weather data.',
    longDescription: 'A low-cost, solar-powered smart irrigation system designed for small-scale Filipino farms. It reads soil moisture levels and cross-references live weather data to deliver precise water quantities, eliminating over-irrigation and drought stress.',
    features: [
    ...
    businessPotential: 'Targets the 5+ million small-scale farmers in the Philippines facing water scarcity. The device can reduce water usage by up to 40% while improving crop yields. High licensing potential with agricultural cooperatives and LGUs.',
  ...
  },
  {
    ...
    college: 'College of Sciences',
    description: 'A multi-modal biometric system combining fingerprint and face recognition to automate student attendance in academic institutions.',
    longDescription: 'Eliminates manual attendance sheets by using dual-factor biometric verification. The system flags habitual absences, generates automated reports, and integrates with student information systems.',
    features: [
    ...
    businessPotential: 'With over 2,000 higher education institutions in the Philippines, the licensing market is substantial. Can be expanded to government offices and corporate HR systems.',
  ...
  },
  {
    ...
    fullTitle: 'FORMULATION OF HIGH-POTASSIUM ORGANIC FERTILIZER FROM BANANA PEEL EXTRACT',
    type: 'Utility Model',
    inventor: 'Prof. G. Aquino',
    college: 'College of Agriculture',
    description: 'A sustainable fertilizer formulation derived from banana peel extract, rich in potassium and micro-nutrients for vegetable crops.',
    longDescription: 'A zero-waste innovation that converts banana peel — a common agricultural by-product — into a high-potassium liquid fertilizer proven to enhance vegetable growth and fruit quality.',
    features: [
    ...
    businessPotential: 'With Philippines producing over 9 million metric tons of bananas annually, the waste conversion opportunity is massive. Attractive to organic farming communities and sustainable agriculture NGOs.',
  ...
  },
  {
    ...
    college: 'College of Engineering',
    description: 'A foldable, high-efficiency parabolic solar cooker designed for community use in off-grid areas, capable of reaching cooking temperatures in 15 minutes.',
    longDescription: 'Uses a parabolic mirror array to concentrate solar energy into a single focal point, achieving temperatures of 250°C sufficient for boiling, frying, and steaming — with zero fuel cost.',
    features: [
    ...
    businessPotential: 'Addresses energy poverty for the estimated 15 million Filipinos without stable electricity. Strong demand from disaster relief agencies such as NDRRMC and international NGOs.',
  ...
  },
  {
    ...
    college: 'College of Arts',
    description: 'A snap-lock modular furniture system that transforms from a study desk to a dining table and shelving unit without any tools.',
    longDescription: 'Designed for the modern urban micro-apartment, this furniture system uses an innovative dovetail snap-lock mechanism allowing reconfiguration in under 2 minutes. Crafted from sustainably sourced bamboo composite panels.',
    features: [
    ...
    businessPotential: 'The Philippine urban furniture market is valued at ₱12 billion. Targets the growing Metro Manila condo and dormitory segment. Highly attractive for e-commerce platforms and IKEA-style local retailers.',
  ...
  },
  {
    ...
    fullTitle: 'BIODEGRADABLE PACKAGING MATERIAL FROM COMPRESSED COCONUT HUSK FIBER',
    type: 'Industrial Design',
    inventor: 'Engr. L. Bautista',
    college: 'College of Sciences',
    description: 'Sustainable packaging panels made from compressed coconut coir fiber — a fully biodegradable, water-resistant alternative to single-use plastic.',
    longDescription: 'A heat-compressed molding process transforms raw coconut husk fiber into rigid, water-resistant packaging shells comparable in durability to conventional foam packaging.',
    features: [
    ...
    businessPotential: 'Growing regulatory pressure against single-use plastics creates a massive market opening. The Philippines produces 15 billion coconuts per year — raw materials are abundantly available and cheap.',
  ...
  },
  {
    ...
    college: 'College of Arts',
    description: 'A registered regional brand identity promoting authentic Palawan-made products and services to domestic and international markets.',
    longDescription: 'A comprehensive brand system including wordmark, logo, color palette, and usage guidelines designed to certify and promote authentic products from Palawan province.',
    features: [
    ...
    businessPotential: 'Protects the "Made in Palawan" brand value for a growing market of eco-tourists, organic consumers, and premium product buyers. Applicable to honey, coconut oil, cashew, seafood, and handicraft sectors.',
  ...
  },
  {
    ...
    college: 'College of Agriculture',
    description: 'Brand identity and trademark registration for PSU\'s Smart Agriculture innovation division, representing the convergence of technology and farming.',
    longDescription: 'A modern brand mark combining circuit-board imagery with agricultural leaf elements, symbolizing the fusion of digital technology and sustainable farming that defines PSU\'s AgriTech research cluster.',
    features: [
    ...
    businessPotential: 'Centralizes PSU\'s AgriTech branding under a single, protected identity. Enhances credibility for grant applications, industry partnerships, and technology licensing deals.',
  ...
  },
  {
    ...
    fullTitle: 'GUIDE TO THE MARINE BIODIVERSITY OF PALAWAN: AN ILLUSTRATED FIELD REFERENCE',
    type: 'Copyright',
    inventor: 'Dr. F. Reyes & Team',
    college: 'College of Sciences',
    description: 'A comprehensive, illustrated field guide documenting over 400 marine species found in the waters of Palawan, authored by PSU marine biologists.',
    longDescription: 'A rigorously peer-reviewed and beautifully illustrated reference guide for marine researchers, dive guides, conservationists, and ecotourists. Covers species identification, habitat notes, conservation status, and local ecological significance.',
    features: [
    ...
    businessPotential: 'High demand from ecotourism operators, DOST-funded conservation programs, and international research institutions studying Coral Triangle biodiversity. Digital e-book edition expandable for global academic licensing.',
  ...
  },
  {
    ...
    fullTitle: 'INTELLILOAD: AUTOMATED FACULTY WORKLOAD COMPUTATION AND SCHEDULING SYSTEM',
    type: 'Copyright',
    inventor: 'BSIT Capstone Group 2025',
    college: 'College of Sciences',
    description: 'An intelligent software system that automates faculty workload computation, scheduling conflict detection, and academic calendar generation.',
    longDescription: 'Replaces spreadsheet-based workload computation with a rules-based engine that automatically calculates teaching units, administrative loads, and research credits per faculty member — producing instant DepEd/CHED-compliant workload reports.',
    features: [
    ...
    businessPotential: 'Applicable to all 130+ State Universities and Colleges (SUCs) in the Philippines running manual workload systems. Clear SaaS subscription model with annual billing to registrar and HR offices.',
...
let systemUsers = [
  ...
  { id: 10, name: 'Anna Reyes', email: 'anna.reyes@psu.edu.ph', role: 'client', dept: 'Research Office', status: 'Active', dateCreated: '2025-12-05' }
];

const auditLogs = [
  { timestamp: '2026-03-27 14:32', user: 'Admin Garcia', action: 'Approved', module: 'Patent', ip: '192.168.1.101', detail: 'Approved PSU-PAT-2026-001' },
  { timestamp: '2026-03-27 13:15', user: 'Maria Santos', action: 'Submitted', module: 'Patent', ip: '192.168.1.45', detail: 'Submitted patent application' },
  { timestamp: '2026-03-26 16:45', user: 'Admin Garcia', action: 'Status Changed', module: 'Trademark', ip: '192.168.1.101', detail: 'Changed PSU-TM-2026-003 to Under Review' },
  { timestamp: '2026-03-26 10:20', user: 'Juan dela Cruz', action: 'Submitted', module: 'Copyright', ip: '192.168.1.78', detail: 'Submitted copyright registration' },
  { timestamp: '2026-03-25 09:00', user: 'Admin Garcia', action: 'Rejected', module: 'Patent', ip: '192.168.1.101', detail: 'Rejected PSU-PAT-2026-004 - Insufficient documentation' },
  { timestamp: '2026-03-24 15:30', user: 'Anna Reyes', action: 'Submitted', module: 'Trademark', ip: '192.168.1.92', detail: 'Submitted trademark application' },
  { timestamp: '2026-03-24 11:00', user: 'Admin Garcia', action: 'Exported', module: 'Reports', ip: '192.168.1.101', detail: 'Exported monthly submission report' },
  { timestamp: '2026-03-23 08:45', user: 'Liza Manalo', action: 'Submitted', module: 'Copyright', ip: '192.168.1.55', detail: 'Submitted copyright registration' },
  { timestamp: '2026-03-22 14:10', user: 'Admin Garcia', action: 'User Created', module: 'Users', ip: '192.168.1.101', detail: 'Created new user account' },
  { timestamp: '2026-03-21 09:30', user: 'Dr. Ricardo Aquino', action: 'Submitted', module: 'Copyright', ip: '192.168.1.33', detail: 'Submitted copyright registration' }
];
...
const OPERATIONAL_AUDIT_MODULES = new Set(['Patent', 'Trademark', 'Copyright', 'Utility Model', 'Industrial Design', 'Reports']);
...
const IPOPHL_TYPES = new Set(['Patent', 'Trademark', 'Utility Model', 'Industrial Design']);

submissions = submissions.map(submission => ({
  ...submission,
  ...(COPYRIGHT_CASE_OVERRIDES[submission.id] || {}),
  ...(IPOPHL_TYPES.has(submission.type) ? (IPOPHL_CASE_OVERRIDES[submission.id] || {}) : {}),
...
systemUsers = systemUsers.map(user => ({ ...user, role: normalizeRole(user.role) }));
...
function getCurrentUser(role = currentRole) {
  ...
  return systemUsers.find(user => user.role === normalizedRole) || systemUsers[0];
}
...
const proposalBlueprint = {
  summary: 'A multi-tiered pre-filing ecosystem that reduces fragmented submission work, protects confidential records, and improves the visibility of PSU innovations before national registration.',
  tags: [
  ...
  problemMatrix: [
    {
      manual: 'Applicants face a knowledge gap across Patent, Trademark, Copyright, Utility Model, and Industrial Design requirements.',
      system: 'Requirement Intelligence groups the exact filing checklists and legal artifacts per IP type before a packet is submitted.'
    },
    {
      manual: 'Paper-dependent intake and fragmented records slow down review and increase incomplete submissions.',
      system: 'A centralized Administrative Mitigation Dashboard gives the IP office one queue for submissions, payment checks, and manual review.'
    },
    {
      manual: 'Payment follow-up and submission completeness are handled through separate manual exchanges.',
      system: 'A Financial Verification Layer requires Proof-of-Deposit or official receipt uploads before the application becomes review-ready.'
    },
    {
      manual: 'University innovations remain under-documented or invisible to collaborators and industry partners.',
      system: 'A searchable innovation marketplace exposes PSU outputs, identifies inventors, and provides a clear inquiry path.'
    }
  ],
  pillars: [
    {
      ...
      description: 'Guided checklists classify the exact documents and legal artifacts needed for each IP service before intake begins.'
    },
    {
      icon: 'fa-table-columns',
      title: 'Administrative Mitigation Dashboard',
      description: 'Authorized personnel review digital packets, manage the processing queue, and monitor the institution-wide IP pipeline.'
    },
    {
      icon: 'fa-file-invoice-dollar',
      title: 'Financial Verification Layer',
      description: 'Proof-of-Deposit or official receipts are mandatory before an application is considered complete for internal review.'
    },
    {
      icon: 'fa-store',
      title: 'Innovation Marketplace',
      description: 'Research outputs and inventions are showcased to external stakeholders for collaboration, technology transfer, and market discovery.'
    }
  ],
  workflow: [
    {
      title: 'Choose the right IP service',
      description: 'The applicant starts with the correct filing path and reviews the exact category-specific requirements.'
    },
    {
      title: 'Build the digital packet',
      description: 'Forms, technical artifacts, and supporting records are uploaded into one structured submission.'
    },
    {
      title: 'Verify financial readiness',
      description: 'Receipt evidence is checked so incomplete packets do not move into the review queue.'
    },
    {
      title: 'Manual office review',
      description: 'Authorized IP office staff assess every file without automated or AI-driven legal evaluation.'
    },
    {
      title: 'Relay official IPOPHL feedback',
      description: 'Administrators update the submission based on registry feedback and institutional follow-through.'
    },
    {
      title: 'Certify, freeze, and expose',
      description: 'Approved records are locked for integrity while qualified innovations remain visible in the marketplace.'
    }
  ],
  securityLayers: [
    {
      ...
      description: 'The prototype login flow now reflects the proposal emphasis on MFA for protecting sensitive academic IP records.'
    },
    {
      icon: 'fa-shield-halved',
      title: 'Role-based access control',
      description: 'Clients, reviewers, PITBI administrators, and super administrators operate inside distinct permission boundaries.'
    },
    {
      icon: 'fa-file-circle-check',
      title: 'Manual evaluation policy',
      description: 'No automated legal judgment is performed; internal reviewers remain the decision point for every submission.'
    },
    {
      icon: 'fa-lock',
      title: 'Frozen certified metadata',
      description: 'Once a record is certified, its core technical metadata is locked to preserve integrity and accountability.'
    }
  ],
  objectives: [
  ...
  stakeholders: [
    {
      ...
      description: 'Structured oversight, lighter document handling, and clearer monitoring of client requests and university records.'
    },
    {
      icon: 'fa-user-graduate',
      title: 'Applicants',
      description: 'Convenient access to IP forms, procedures, requirements, and private tracking for their own submissions.'
    },
    {
      icon: 'fa-handshake',
      title: 'External Stakeholders and Industry Partners',
      description: 'A clearer path to discover university innovations, identify inventors, and start collaboration or technology transfer conversations.'
    },
    {
      icon: 'fa-book',
      title: 'Future Researchers',
      description: 'A concrete reference model for institutional IP management, innovation promotion, and secure digital service design.'
    }
  ],
  scope: [
    ...
    local: [
      {
        ...
        insight: 'State universities still rely heavily on manual IP processing, reinforcing the need for a centralized digital intake platform.'
      },
      {
        citation: 'Mendoza and Santos (2024)',
        insight: 'A web-based IP documentation system improved traceability and received high marks for ease of use and security.'
      },
      {
        citation: 'Villanueva and Garcia (2022)',
        insight: 'Limited visibility of research outputs weakens commercialization, which supports integrating a marketplace into the platform.'
      },
      {
        citation: 'Reyes and Aquino (2023)',
        insight: 'Data privacy gaps in academic IP management point directly to MFA, access control, and audit logging as necessary safeguards.'
      }
    ],
    foreign: [
      {
        citation: 'Jacob and Lefgren (2021)',
        insight: 'Centralized IP systems at research universities are linked to better patenting outcomes and stronger industry partnerships.'
      },
      {
        citation: 'Williams and Kumar (2022)',
        insight: 'Dedicated online innovation showcases improve engagement, licensing potential, and startup creation.'
      },
      {
        citation: 'Rodriguez and Lee (2021)',
        insight: 'Layered security controls reduce unauthorized access incidents in academic IP environments.'
      },
      {
        citation: 'Cahyanto et al. (2024)',
        insight: 'Their MFA review found major reductions in breach risk and stronger user trust in digital academic systems.'
      }
    ]
  }
};
...
function typeBadge(type) {
  const m = { Patent: 'badge-patent', Copyright: 'badge-copyright', Trademark: 'badge-trademark', 'Utility Model': 'badge-utility', 'Industrial Design': 'badge-industrial' };
  return `<span class="badge ${m[type] || 'badge-pending'}">${type}</span>`;
}
function statusBadge(status) {
  const m = { Approved: 'badge-approved', Pending: 'badge-pending', 'Under Review': 'badge-review', Rejected: 'badge-rejected', 'Awaiting Documents': 'badge-review' };
...
function navigateTo(page, isBack = false) {
  ...
  const dashboardPages = ['user-dashboard', 'admin-dashboard', 'admin-submissions', 'admin-search', 'patent-form', 'trademark-form', 'copyright-form', 'utility-form', 'industrial-form', 'submission-detail', 'marketplace-dash', 'admin-marketplace', 'audit-log', 'user-profile', 'user-submissions', 'admin-records', 'admin-users', 'admin-settings', 'role-permissions', 'create-account', 'faq-dash', 'ip-tutorial', 'project-blueprint'];

  if (page === 'landing') {
    document.getElementById('public-nav').classList.add('active');
    document.getElementById('page-landing').classList.add('active');
    initLandingMarketplace();
...
function initLandingMarketplace() {
  const grid = document.getElementById('landingInnovationGrid');
  if (grid) {
    grid.innerHTML = renderInnovationCards(marketplaceItems);
  }
}

function renderProposalComparisonRows() {
  return proposalBlueprint.problemMatrix.map(item => `
...
function renderProposalPillars() {
  return proposalBlueprint.pillars.map(item => `
...
function renderProposalWorkflow() {
  return proposalBlueprint.workflow.map((item, index) => `
...
function renderProposalObjectives() {
  return proposalBlueprint.objectives.map(item => `
    <li><i class="fa-solid fa-circle-check"></i><span>${item}</span></li>
  `).join('');
}

function renderProposalQualityTargets() {
  return proposalBlueprint.qualityTargets.map(item => `
...
function renderProposalStakeholders() {
  return proposalBlueprint.stakeholders.map(item => `
    <div class="proposal-mini-card">
      <i class="fa-solid ${item.icon}"></i>
      <h4>${item.title}</h4>
      <p>${item.description}</p>
...
function renderProposalSecurityLayers() {
  return proposalBlueprint.securityLayers.map(item => `
    <div class="proposal-mini-card">
      <i class="fa-solid ${item.icon}"></i>
      <h4>${item.title}</h4>
      <p>${item.description}</p>
...
function filterLandingMarketplace() {
  ...
  const college = document.getElementById('landingFilterCollege')?.value || 'All';
  const search = document.getElementById('landingSearch')?.value.toLowerCase() || '';
  ...
  const grid = document.getElementById('landingInnovationGrid');
  if (grid) {
    grid.innerHTML = filtered.length ? renderInnovationCards(filtered) : '<p style="grid-column:1/-1;text-align:center;color:var(--gray-500);padding:60px 0;font-weight:600">No innovations found matching your criteria.</p>';
  }
}
...
function handleLogin(e) {
  ...
  if (!email) { showError('loginEmailError', 'Email is required'); valid = false; } else { hideError('loginEmailError'); }
  if (!pass) { showError('loginPasswordError', 'Password is required'); valid = false; } else if (pass.length < 3) { showError('loginPasswordError', 'Password too short'); valid = false; } else { hideError('loginPasswordError'); }
...
function hideError(id) {
  ...
  el.previousElementSibling?.querySelector('input')?.classList.remove('input-error');
}
...
function toggleSidebar() {
  ...
  if (window.innerWidth <= 768) {
    ...
    document.getElementById('dashboard-topbar').style.left = sidebarCollapsed ? 'var(--sidebar-collapsed-w)' : 'var(--sidebar-w)';
  }
}
...
function renderSidebar() {
  ...
  const menuMap = {
    superadmin: [
      { page: 'admin-dashboard', icon: 'fa-chart-line', text: 'Admin Console' },
      ...
      { page: 'role-permissions', icon: 'fa-shield-halved', text: 'Permissions' },
    ...
    pitbi_admin: [
      ...
      { page: 'admin-users', icon: 'fa-users', text: 'User Roles' },
      { page: 'create-account', icon: 'fa-user-plus', text: 'Create Account' },
      { page: 'audit-log', icon: 'fa-clipboard-list', text: 'Audit Trail' },
      { page: 'role-permissions', icon: 'fa-shield-halved', text: 'Permissions' },
      { page: 'user-profile', icon: 'fa-user', text: 'Profile' }
    ],
    reviewer: [
      ...
      { page: 'admin-search', icon: 'fa-magnifying-glass', text: 'Prior Art Search' },
      { page: 'user-profile', icon: 'fa-user', text: 'Profile' }
    ],
    client: [
      ...
      { page: 'industrial-form', icon: 'fa-pen-nib', text: 'File Industrial Design' },
...
function renderDashboardContent(page) {
  ...
  switch(page) {
    case 'user-dashboard': mc.innerHTML = renderUserDashboard(); break;
    case 'admin-dashboard': mc.innerHTML = renderAdminDashboard(); setTimeout(() => initCharts(), 100); break;
    case 'admin-submissions': mc.innerHTML = renderAdminSubmissionsPage(); break;
    case 'admin-search': mc.innerHTML = renderIPSearchPage(); break;
    case 'patent-form': currentWizardStep = 1; currentFormType = 'patent'; mc.innerHTML = renderFormWizard('Patent Application'); break;
    case 'trademark-form': currentWizardStep = 1; currentFormType = 'trademark'; mc.innerHTML = renderFormWizard('Trademark Application'); break;
    case 'copyright-form': currentWizardStep = 1; currentFormType = 'copyright'; mc.innerHTML = renderFormWizard('Copyright Registration'); break;
    case 'utility-form': currentWizardStep = 1; currentFormType = 'utility'; mc.innerHTML = renderFormWizard('Utility Model Application'); break;
    case 'industrial-form': currentWizardStep = 1; currentFormType = 'industrial'; mc.innerHTML = renderFormWizard('Industrial Design Registration'); break;
    case 'submission-detail': mc.innerHTML = renderSubmissionDetail(); break;
    case 'marketplace-dash': case 'admin-marketplace': mc.innerHTML = renderMarketplace(); break;
    case 'audit-log': mc.innerHTML = renderAuditLog(); break;
    case 'user-profile': mc.innerHTML = renderProfile(); break;
    case 'user-submissions': mc.innerHTML = renderUserSubmissions(); break;
    case 'admin-records': mc.innerHTML = renderAdminRecords(); break;
    case 'admin-users': mc.innerHTML = renderAdminUsers(); break;
    case 'admin-settings': mc.innerHTML = renderAdminSettings(); break;
    case 'role-permissions': mc.innerHTML = renderRolePermissions(); break;
    case 'create-account': mc.innerHTML = renderCreateAccount(); break;
    case 'faq-dash': mc.innerHTML = renderFaq(); break;
    case 'ip-tutorial': mc.innerHTML = renderIpTutorial(); break;
    case 'project-blueprint': mc.innerHTML = renderProjectBlueprint(); break;
...
function renderUserDashboard() {
  ...
  const pending = userSubmissions.filter(s => s.status === 'Pending' || s.status === 'Under Review' || s.status === 'Awaiting Documents').length;
  ...
  return `
    ...
    <div class="quick-actions" style="margin-top:24px">
      <button class="quick-action-btn" onclick="navigateTo('patent-form')"><i class="fa-solid fa-lightbulb"></i>File Patent</button>
      <button class="quick-action-btn" onclick="navigateTo('trademark-form')"><i class="fa-solid fa-stamp"></i>File Trademark</button>
      <button class="quick-action-btn" onclick="navigateTo('copyright-form')"><i class="fa-solid fa-copyright"></i>File Copyright</button>
      <button class="quick-action-btn" onclick="navigateTo('utility-form')"><i class="fa-solid fa-gears"></i>File Utility Model</button>
      <button class="quick-action-btn" onclick="navigateTo('industrial-form')"><i class="fa-solid fa-pen-nib"></i>File Industrial Design</button>
      <button class="quick-action-btn" onclick="navigateTo('ip-tutorial')"><i class="fa-solid fa-book-open"></i>IP Tutorial</button>
      <button class="quick-action-btn" onclick="navigateTo('faq-dash')"><i class="fa-solid fa-circle-question"></i>FAQ</button>
    </div>
    <div class="table-container" style="margin-top:24px">
      ...
      <div class="table-responsive"><table class="data-table"><thead><tr><th>Reference No.</th><th>Type</th><th>Title</th><th>Date Submitted</th><th>Status</th></tr></thead><tbody>
        ${recent.length
          ? recent.map(s => `<tr onclick="viewSubmission('${s.id}')" style="cursor:pointer"><td><strong>${s.id}</strong></td><td>${typeBadge(s.type)}</td><td>${s.title}</td><td>${s.date}</td><td>${statusBadge(s.status)}</td></tr>`).join('')
...
function renderFaq() {
  const faqData = {
    patent: [
      { q: "What is a Patent?", a: "A patent is an exclusive right granted for an invention, which is a product or a process that provides a new way of doing something, or offers a new technical solution to a problem." },
      { q: "How long does patent protection last?", a: "Patent protection is granted for a limited period, generally 20 years from the filing date of the application subject to the payment of annual maintenance fees." },
      { q: "What can be patented?", a: "An invention can be patented if it is new, involves an inventive step, and is industrially applicable." },
      { q: "Is a Philippine patent valid in other countries?", a: "No. Patents are territorial rights. A Philippine patent is only valid within the Philippines." },
      { q: "What are the required documents to file a patent?", a: "<strong>Required Documents:</strong><ul style='margin-top:10px; padding-left:20px; line-height: 1.8;'><li>Patent Application Form (PSU-IPO-PAT-01)</li><li>Invention Disclosure Statement</li><li>Technical Drawings / Diagrams</li><li>Abstract (150 words max)</li><li>Claims Statement</li></ul>" }
    ],
    trademark: [
      { q: "What is a Trademark?", a: "A trademark is a tool used to differentiate goods and services from each other. It is a very important marketing tool that makes the public recognize the product or service." },
      { q: "What are the requirements for registration?", a: "You need a completed application form, a clear drawing or reproduction of the mark, and payment of the filing fee." },
      { q: "How long is a trademark valid?", a: "A trademark registration is valid for 10 years and may be renewed for periods of 10 years as long as the mark remains in commercial use." },
      { q: "What are the required documents to file a trademark?", a: "<strong>Required Documents:</strong><ul style='margin-top:10px; padding-left:20px; line-height: 1.8;'><li>Trademark Application Form (PSU-IPO-TM-01)</li><li>Mark Specimen / Logo File (300+ DPI)</li><li>Description of Goods/Services</li><li>Declaration of First Use</li></ul>" }
    ],
    copyright: [
    ...
    utilityModel: [
      ...
      { q: "What is the difference between a patent and a utility model?", a: "A utility model does not require an 'inventive step' (non-obviousness), making it easier and faster to obtain, but it usually offers a shorter term of protection (typically 7 years without renewal)." },
      { q: "What are the required documents to file a utility model?", a: "<strong>Required Documents:</strong><ul style='margin-top:10px; padding-left:20px; line-height: 1.8;'><li>Utility Model Application Form</li><li>Technical Description</li><li>Drawings/Illustrations</li><li>Claims Statement</li></ul>" }
    ],
    industrialDesign: [
      { q: "What is an Industrial Design?", a: "An industrial design constitutes the ornamental or aesthetic aspect of an article. It may consist of three-dimensional features, such as the shape or surface, or of two-dimensional features, such as patterns, lines, or color." },
      { q: "Why protect industrial designs?", a: "Protecting an industrial design ensures an exclusive right against unauthorized copying or imitation of the design by third parties, protecting the commercial value." },
      { q: "How long is the term of protection?", a: "Protection for an industrial design is valid for five (5) years from the filing date, and it may be renewed for not more than two (2) consecutive periods of five (5) years." },
      { q: "What are the required documents to register an industrial design?", a: "<strong>Required Documents:</strong><ul style='margin-top:10px; padding-left:20px; line-height: 1.8;'><li>Industrial Design Application Form</li><li>Design Representation (Photos/3D)</li><li>Description of Design</li></ul>" }
    ]
  };
...
function legacyGetRoleSpecificStats(role) {
  ...
  const baseStats = {
    superadmin: {
      title: 'Full System Control', subtitle: 'Global oversight of all university IP activities.',
      cards: [
        { label: 'System Users', value: systemUsers.length, icon: 'fa-users', color: 'blue' },
        { label: 'Total Logs', value: auditLogs.length, icon: 'fa-clipboard-list', color: 'yellow' },
        { label: 'Storage Used', value: '4.2 GB', icon: 'fa-database', color: 'green' },
    ...
    pitbi_admin: {
      ...
      cards: [
        ...
        { label: 'Registered IPs', value: approvedCount, icon: 'fa-certificate', color: 'green' },
        { label: 'Revenue Flow', value: '₱125k', icon: 'fa-money-bill-trend-up', color: 'indigo' }
      ]
    },
    admin: {
      title: 'PITBI Operations', subtitle: 'Managing the university core IP portfolio.',
      cards: [
        ...
        { label: 'Pending Review', value: pending, icon: 'fa-hourglass-half', color: 'yellow' },
        { label: 'Registered IPs', value: approvedCount, icon: 'fa-certificate', color: 'green' },
        { label: 'Revenue Flow', value: 'P125k', icon: 'fa-money-bill-trend-up', color: 'indigo' }
      ]
    },
    specialist: {
      title: 'Technical Review Hub', subtitle: 'Examine and evaluate technical disclosures.',
      cards: [
        { label: 'Assigned to Me', value: 3, icon: 'fa-file-signature', color: 'blue' },
        { label: 'In Evaluation', value: 2, icon: 'fa-microscope', color: 'yellow' },
        { label: 'Completed', value: 12, icon: 'fa-check-double', color: 'green' },
        { label: 'Prior Art Docs', value: '1.5k', icon: 'fa-magnifying-glass', color: 'indigo' }
      ]
    },
    ipo_director: {
      title: 'Executive Oversight', subtitle: 'Approval gating and strategic IP management.',
      cards: [
        { label: 'Awaiting Sig', value: 5, icon: 'fa-pen-fancy', color: 'blue' },
        { label: 'Univ Portfolio', value: 156, icon: 'fa-ranking-star', color: 'yellow' },
        { label: 'Policy Alerts', value: 0, icon: 'fa-shield-check', color: 'green' },
        { label: 'Growth Index', value: '+12%', icon: 'fa-arrow-trend-up', color: 'indigo' }
      ]
    },
    dept_head: {
      title: 'Department Portal', subtitle: 'Endorsing college-level innovations.',
      cards: [
        { label: 'Dept Submissions', value: 18, icon: 'fa-building-columns', color: 'blue' },
        { label: 'Needs Endorsement', value: 4, icon: 'fa-certificate', color: 'yellow' },
        { label: 'Approved Faculty', value: 6, icon: 'fa-user-graduate', color: 'green' },
        { label: 'Grant Status', value: 'Active', icon: 'fa-hand-holding-dollar', color: 'indigo' }
      ]
    },
    facilitator: {
      title: 'Facilitator Tools', subtitle: 'Assisting creators with their applications.',
      cards: [
        { label: 'Active Support', value: 8, icon: 'fa-handshake-angle', color: 'blue' },
        { label: 'Follow-ups', value: 3, icon: 'fa-comment-dots', color: 'yellow' },
        { label: 'Completed Prep', value: 24, icon: 'fa-file-circle-check', color: 'green' },
        { label: 'Clients', value: 12, icon: 'fa-users', color: 'indigo' }
      ]
    },
    external_expert: {
      title: 'External Evaluation', subtitle: 'Third-party specialized technical review.',
      cards: [
        { label: 'New Dossiers', value: 1, icon: 'fa-folder-plus', color: 'blue' },
        { label: 'In Analysis', value: 1, icon: 'fa-flask-vial', color: 'yellow' },
        { label: 'Reports Filed', value: 8, icon: 'fa-file-export', color: 'green' },
...
function legacyGetRoleSpecificPanels(role) {
  ...
  const mainPanelTitle = role === 'ipo_director' ? 'Awaiting Signature' : (role === 'specialist' ? 'Technical Assignment' : 'Action Required');
...
function getRoleSpecificStats(role) {
  ...
  const pending = visibleSubmissions.filter(s => s.status === 'Pending' || s.status === 'Under Review' || s.status === 'Awaiting Documents').length;
  ...
  const baseStats = {
    superadmin: {
      ...
      cards: [
        { label: 'System Users', value: systemUsers.length, icon: 'fa-users', color: 'blue' },
        { label: 'Audit Events', value: getVisibleAuditLogs(role).length, icon: 'fa-clipboard-list', color: 'yellow' },
        { label: 'Active Cases', value: total, icon: 'fa-database', color: 'green' },
    ...
    pitbi_admin: {
      ...
      cards: [
        ...
        { label: 'Pending Review', value: pending, icon: 'fa-hourglass-half', color: 'yellow' },
        { label: 'Registered IPs', value: approvedCount, icon: 'fa-certificate', color: 'green' },
        { label: 'Operational Logs', value: getVisibleAuditLogs(role).length, icon: 'fa-clipboard-list', color: 'indigo' }
      ]
    },
    reviewer: {
      title: 'Reviewer Workspace', subtitle: 'Process assigned cases within reviewer-only permissions.',
      cards: [
        { label: 'Assigned Cases', value: total, icon: 'fa-file-signature', color: 'blue' },
        { label: 'In Review', value: pending, icon: 'fa-microscope', color: 'yellow' },
        { label: 'Advanced Stages', value: approvedCount, icon: 'fa-check-double', color: 'green' },
        { label: 'Search Access', value: 'Internal', icon: 'fa-magnifying-glass', color: 'indigo' }
      ]
    }
  };
...
function getRoleSpecificPanels(role) {
  ...
  const mainPanelTitle = normalizedRole === 'reviewer' ? 'Assigned Review Queue' : 'Action Required';
      ...
      <div class="dashboard-panel" style="background:rgba(255,255,255,0.9); backdrop-filter:blur(12px); border-radius:16px; padding:24px; border: 1px solid rgba(255,255,255,0.8); box-shadow:0 8px 30px rgba(0,0,0,0.03);">
        ...
        <div class="table-responsive">
          <table class="data-table" style="width:100%; font-size: 0.9rem;">
            <thead><tr><th>Reference</th><th>Type</th><th>Status</th><th>Action</th></tr></thead>
            <tbody>
            ${(submissionsList.length ? submissionsList : []).map(s => `
              <tr>
                <td><strong>${s.id}</strong></td>
                <td>${typeBadge(s.type)}</td>
                <td>${statusBadge(s.status)}</td>
            ...
            `).join('') || '<tr><td colspan="4" style="text-align:center;padding:24px;color:var(--gray-400)">No cases available for this role.</td></tr>'}
          </tbody>
        </table>
      </div>
    </div>
...
function initCharts() {
  ...
  if (pieCtx) {
    ...
    window.myPieChart = new Chart(pieCtx, {
      type: 'doughnut',
      data: {
        labels: ['Patent', 'Trademark', 'Copyright', 'Utility Model', 'Ind. Design'],
        datasets: [{
          data: [35, 25, 20, 10, 10],
          backgroundColor: ['#E66B3F', '#F7BEA2', '#22C55E', '#3B82F6', '#8B5CF6'],
          borderWidth: 0,
          hoverOffset: 4
        }]
      },
...
function switchRole(role) {
  ...
  if (user) {
    showToast(`Access switched to: ${user.name} (${getRoleMeta(currentRole).label})`);
  }
...
function renderAdminSubmissionsPage() {
  adminFilterType = 'All'; adminFilterStatus = 'All'; adminSearchQuery = '';
  const normalizedRole = normalizeRole(currentRole);
  const title = normalizedRole === 'reviewer' ? 'Assigned Cases' : 'All Submissions';
  const subtitle = normalizedRole === 'reviewer'
...
function renderAdminSubmissionsTable(filterType, filterStatus, searchQuery) {
  ...
  if (filterType && filterType !== 'All') filtered = filtered.filter(s => s.type === filterType);
  if (filterStatus && filterStatus !== 'All') filtered = filtered.filter(s => s.status === filterStatus);
  if (searchQuery) {
...
let adminFilterType = 'All', adminFilterStatus = 'All', adminSearchQuery = '';
function filterAdminTable(type) { adminFilterType = type; refreshAdminTable(); }
function filterAdminStatus(status) { adminFilterStatus = status; refreshAdminTable(); }
function filterAdminSearch(q) { adminSearchQuery = q; refreshAdminTable(); }
function refreshAdminTable() {
  const container = document.getElementById('adminSubmissionsTable');
  if (container) {
    const newHtml = renderAdminSubmissionsTable(adminFilterType, adminFilterStatus, adminSearchQuery);
...
function requestDocs(id) {
  ...
  const missing = prompt("Please specify the missing documents for this submission (e.g., PSA-IPO-PAT-01 Signature, Invention Disclosure):", "");
  
  if (missing !== null) { // If user didn't cancel
...
function viewSubmission(id) {
  const submission = submissions.find(s => s.id === id);
  if (!submission || !getVisibleSubmissions(currentRole).some(s => s.id === id)) {
...
const COPYRIGHT_OPERATION_FLOW = [
  ...
  },
  {
    ...
    owner: 'Client',
    lane: 'Author / Applicant',
    description: 'The applicant receives the payment slip and pays the basic fees to the university cashier.'
  },
  {
    key: 'cashier-receipt',
    step: 5,
    title: 'University Cashier receives payment slip/cash and issues official receipt to author',
    owner: 'University Cashier',
    lane: 'Cashier',
    description: 'The University Cashier receives payment and issues the official receipt. Prepares monthly collection report copy furnished UIP/ITSO office.'
  },
  {
    key: 'receipt-submitted',
    step: 6,
    title: 'Author receives official receipt from cashier and submit photocopy to Admin Staff/MIS',
    owner: 'Client',
    lane: 'Author / Applicant',
    description: 'The applicant submits the photocopied official receipt to Admin Staff/MIS after cashier payment.'
  },
  {
    key: 'mis-forwarding',
    step: 7,
  ...
  },
  {
    ...
    owner: 'Super Admin',
    lane: 'IP Director',
    description: 'Verify and prioritize. Endorse to the University President through the VP Research & Extension list of applications for approval. File IP applications with the National Library (Note: the IP Director may authorize the technical expert/admin staff/MIS to file applications on his/her behalf).'
  },
  {
  ...
  },
  {
    ...
    owner: 'Client',
    lane: 'Author / Applicant',
    description: 'The author receives the Certificate of Registration from Admin Staff, completing the registration process.'
  }
];
...
const IPOPHL_OPERATION_FLOW = [
  {
    ...
    description: 'Submit a properly filled-out application for Patent, UM, ID, or Trademark together with other requirements of the IPOPHL, and a letter-request approved by the University President through the VP for R&D (if applicable).'
  },
  {
    key: 'technical-review',
    step: 2,
    ...
    owner: 'Reviewer',
    lane: 'Technical Expert',
    description: 'The Technical Expert reviews and prepares a checklist, assists the inventor if the application is incomplete, and forwards the complete application to Admin Staff/MIS for record purposes.'
  },
  {
    key: 'mis-recording',
    step: 3,
  ...
  },
  {
    ...
    owner: 'Client',
    lane: 'Inventor / Applicant',
    description: 'The inventor receives the payment slip and pays the basic fees to the university cashier.'
  },
  {
    key: 'cashier-receipt',
    step: 5,
    ...
    owner: 'University Cashier',
    lane: 'Cashier',
    description: 'The University Cashier receives the payment slip/cash and issues an official receipt to the inventor. Prepares monthly collection report copy furnished to UIP/ITSO office.'
  },
  {
    key: 'receipt-submitted',
    step: 6,
    ...
    owner: 'Client',
    lane: 'Inventor / Applicant',
    description: 'The inventor receives the official receipt from the cashier and submits a photocopy to Admin Staff/MIS.'
  },
  {
    key: 'mis-forwarding',
    step: 7,
  ...
  },
  {
    ...
    owner: 'Super Admin',
    lane: 'IP Director',
    description: 'Verifies and prioritizes the application, endorses it to the University President through the VP for Research & Extension, and files IP applications with IPOPHL.'
  },
  {
    key: 'certificate-received',
    step: 9,
  ...
  },
  {
    ...
    owner: 'Client',
    lane: 'Inventor / Applicant',
    description: 'The inventor receives the Certificate of Registration from Admin Staff, completing the IP registration process.'
  }
];
...
const IPOPHL_TRACKING_GROUPS = [
  ...
  { label: 'IPOPHL Filing', keys: ['ip-director-action', 'certificate-received'] },
  { label: 'Certificate Released', keys: ['certificate-released'] }
];
...
function getCopyrightStageKey(submission) {
  ...
  if (submission.status === 'Under Review') return (submission.paymentExempt || submission.paymentVerified !== false) ? 'ip-director-action' : 'payment-slip-issued';
...
function syncSubmissionWorkflowState(submission) {
  ...
  if (submission.status === 'Under Review') {
    submission.copyrightStage = (submission.paymentExempt || submission.paymentVerified !== false) ? 'ip-director-action' : 'payment-slip-issued';
    return;
  }
  if (submission.status === 'Pending') {
    ...
    submission.copyrightStage = submission.copyrightStage || (submission.paymentVerified !== false ? 'mis-forwarding' : 'technical-review');
  }
}

function getCopyrightTrackingSteps(submission) {
  const stageKey = getCopyrightStageKey(submission);
  const activeIdx = COPYRIGHT_TRACKING_GROUPS.findIndex(group => group.keys.includes(stageKey));
  const closed = submission.status === 'Rejected' || submission.status === 'Archived';
...
function syncIPOPHLWorkflowState(submission) {
  ...
  if (submission.status === 'Under Review') {
    submission.ipophlStage = (submission.paymentExempt || submission.paymentVerified !== false) ? 'ip-director-action' : 'payment-slip-issued';
    return;
  }
  if (submission.status === 'Pending') {
    if (submission.paymentExempt) {
    ...
    submission.ipophlStage = submission.ipophlStage || (submission.paymentVerified !== false ? 'mis-forwarding' : 'technical-review');
  }
}

function getIPOPHLTrackingSteps(submission) {
  const stageKey = getIPOPHLStageKey(submission);
  const activeIdx = IPOPHL_TRACKING_GROUPS.findIndex(group => group.keys.includes(stageKey));
  const closed = submission.status === 'Rejected' || submission.status === 'Archived';
...
function getSubmissionPaymentMeta(submission) {
  ...
  if (IPOPHL_TYPES.has(submission.type)) {
    if (submission.paymentExempt) {
      return {
        ...
        detail: 'An approved university letter-request is on file. The inventor is faculty or staff whose work is part of regular official duties, so basic fees are waived.',
        actionLabel: ''
      };
    }
    if (submission.paymentVerified === false) {
      return {
        ...
        detail: 'After completeness check by the Technical Expert, Admin Staff/MIS issues the payment slip. The inventor pays at the cashier and returns the official receipt copy.',
        actionLabel: 'Record OR Copy'
      };
    }
    return {
  ...
  if (submission.paymentVerified === false) {
    return {
      ...
      detail: 'Upload or record the official receipt before forwarding the packet for review.',
  ...
  return `
    ...
    <div class="copyright-flow-grid">
      ${COPYRIGHT_OPERATION_FLOW.map((step, idx) => {
        ...
        const stateLabel = state === 'completed' ? 'Completed' : state === 'active' ? 'Current' : 'Pending';
  ...
  return `
    ...
    <div class="copyright-flow-grid">
      ${IPOPHL_OPERATION_FLOW.map((step, idx) => {
        ...
        const stateLabel = skipped ? (state === 'completed' ? 'Skipped' : 'Fee-waived') : (state === 'completed' ? 'Completed' : state === 'active' ? 'Current' : 'Pending');
...
function togglePaymentStatus(id) {
  ...
  if (submission.paymentVerified) {
    submission.officialReceiptNumber = submission.officialReceiptNumber && !submission.officialReceiptNumber.includes('Pending')
    ...
    submission.officialReceiptNumber = submission.type === 'Copyright' ? 'Pending cashier receipt' : 'Pending receipt validation';
    if (submission.type === 'Copyright') {
...
function renderIPSearchPage() {
  const normalizedRole = normalizeRole(currentRole);
  const results = (normalizedRole === 'reviewer' ? getVisibleSubmissions(currentRole) : submissions)
    .filter(item => item.status === 'Approved' || normalizedRole === 'reviewer')
    .slice(0, 5);
  return `
    <div class="page-header">
...
function renderSubmissionDetail() {
  ...
  const topSecretAccess = s.hasTopSecretAnnex ? getDownloadAccess(s, 'top_secret') : 'deny';
  const paymentMeta = getSubmissionPaymentMeta(s);
  const paymentStyles = paymentMeta.theme === 'green'
    ? { bg: 'rgba(22,163,74,0.06)', border: 'rgba(22,163,74,0.2)', color: 'var(--green)' }
    : paymentMeta.theme === 'blue'
      ? { bg: 'rgba(59,130,246,0.06)', border: 'rgba(59,130,246,0.2)', color: 'var(--navy)' }
      : { bg: 'rgba(239,68,68,0.06)', border: 'rgba(239,68,68,0.2)', color: 'var(--red)' };
  const copyrightStage = s.type === 'Copyright' ? COPYRIGHT_OPERATION_FLOW.find(step => step.key === getCopyrightStageKey(s)) : null;
  ...
  return `
    ...
    ${frozen ? `<div style="padding:14px 20px; background:rgba(99,102,241,0.06); border:1px solid rgba(99,102,241,0.2); border-radius:10px; margin-bottom:24px; display:flex; align-items:center; gap:12px;">
    ...
    <div class="detail-layout">
      ...
      <div>
        <div class="detail-panel">
          ...
          </label>` : frozen ? '<p style="font-size:.8rem;color:#6366f1;background:rgba(99,102,241,0.06);padding:10px;border-radius:6px;"><i class="fa-solid fa-lock"></i> Status changes are locked for certified submissions.</p>' : ''}
          ${canAdvanceSubmission(s) && !frozen ? `<div class="detail-actions">
...
function getFormGuideContent() {
  const guides = {
    patent: { title: 'Patent Application Guide', icon: 'fa-lightbulb', color: '#3b82f6', steps: ['Prepare inventor details (name, ID, department, email)', 'Document your invention with detailed description and field of technology', 'Prepare technical drawings and claims statement', 'Upload all documents in PDF format', 'Submit and receive your reference number for tracking'], docs: ['Patent Application Form (PSU-IPO-PAT-01)', 'Invention Disclosure Statement (min 2 pages)', 'Technical Drawings / Diagrams', 'Abstract (150 words max)', 'Claims Statement', 'Proof of Concept (optional)', 'Prior Art Search Report (optional)'] },
    trademark: { title: 'Trademark Registration Guide', icon: 'fa-stamp', color: '#f59e0b', steps: ['Provide applicant details and ownership type', 'Define mark name, type (word/logo/combination), and goods/services', 'Upload high-resolution mark specimen (PNG/JPG, 300+ DPI)', 'Submit and track your application status'], docs: ['Trademark Application Form (PSU-IPO-TM-01)', 'Mark Specimen / Logo File (min 300 DPI)', 'Description of Goods/Services', 'Declaration of First Use', 'Color Claim Statement (if applicable)'] },
    copyright: { title: 'Copyright Registration Guide', icon: 'fa-copyright', color: '#10b981', steps: ['List all authors/creators with contributions', 'Describe the work — title, type, date of creation', 'Upload complete copy of the work being registered', 'Submit and receive Certificate of Registration'], docs: ['Copyright Registration Form (PSU-IPO-CR-01)', 'Complete Copy of the Work', 'Valid Philippine ID (Digitized)', 'Declaration of Originality', 'Authorship Agreement (for multiple authors)', 'Publication History (if published, optional)'] },
    utility: { title: 'Utility Model Guide', icon: 'fa-gears', color: '#6366f1', steps: ['Prepare inventor and technical details', 'Describe the technical innovation and its industrial use', 'Upload technical drawings/diagrams', 'Submit and track application'], docs: ['Utility Model Application Form', 'Technical Description', 'Technical Drawings', 'Claims Statement'] },
    industrial: { title: 'Industrial Design Guide', icon: 'fa-pen-nib', color: '#ec4899', steps: ['Provide applicant and product details', 'Upload high-quality representations (photos/drawings) of the design', 'Provide description of design features', 'Submit and track application'], docs: ['Industrial Design Application Form', 'Design Representation Files', 'Description of Design'] }
  };
...
function renderFormWizard(title) {
  const steps = ['Applicant Info', getStep2Label(), 'Upload Documents', 'Review & Submit'];
  return `
    <div class="page-header"><h1>${title}</h1><p>Complete all steps to submit your application.</p></div>
    ${getFormGuideContent()}
    <div class="wizard-container">
      <div class="wizard-progress">
        ${steps.map((s, i) => `<div class="wizard-step ${i+1===currentWizardStep?'active':''} ${i+1<currentWizardStep?'completed':''}" id="wizStep${i+1}">
...
function getStep2Label() {
  if (currentFormType === 'patent' || currentFormType === 'utility') return 'Invention Details';
...
function renderStep3() {
  const docMap = {
    patent: ['Patent Application Form (PSU-IPO-PAT-01)', 'Invention Disclosure Statement', 'Technical Drawings / Diagrams', 'Abstract', 'Claims Statement'],
    trademark: ['Trademark Application Form (PSU-IPO-TM-01)', 'Mark Specimen / Logo File (300+ DPI)', 'Description of Goods/Services', 'Declaration of First Use'],
    copyright: ['Copyright Registration Form (PSU-IPO-CR-01)', 'Complete Copy of the Work', 'Valid Philippine ID (Digitized)', 'Declaration of Originality'],
    utility: ['Utility Model Application Form', 'Technical Description', 'Technical Drawings/Illustrations', 'Claims Statement', 'Novelty Statement'],
    industrial: ['Industrial Design Application Form', 'Design Representations (Photos/3D renders)', 'Description of Design', 'Product Category Statement']
  };
...
function renderStep4Review() {
  const val = (v) => v ? `<span class="value">${v}</span>` : `<span class="value" style="color:var(--gray-400);font-style:italic;">Not provided</span>`;
...
function captureWizardData() {
  if (currentWizardStep === 1) {
    wizardData.name = document.getElementById('wiz-name')?.value || wizardData.name || '';
    wizardData.email = document.getElementById('wiz-email')?.value || wizardData.email || '';
    wizardData.dept = document.getElementById('wiz-dept')?.value || wizardData.dept || '';
    wizardData.college = document.getElementById('wiz-college')?.value || wizardData.college || '';
    wizardData.contact = document.getElementById('wiz-contact')?.value || wizardData.contact || '';
  }
  if (currentWizardStep === 2) {
    wizardData.title = document.getElementById('wiz-title')?.value || wizardData.title || '';
    wizardData.date = document.getElementById('wiz-date')?.value || wizardData.date || '';
    wizardData.desc = document.getElementById('wiz-desc')?.value || wizardData.desc || '';
    wizardData.field = document.getElementById('wiz-field')?.value || wizardData.field || '';
    wizardData.abstract = document.getElementById('wiz-abstract')?.value || wizardData.abstract || '';
    wizardData.claims = document.getElementById('wiz-claims')?.value || wizardData.claims || '';
    wizardData.marktype = document.getElementById('wiz-marktype')?.value || wizardData.marktype || '';
    wizardData.worktype = document.getElementById('wiz-worktype')?.value || wizardData.worktype || '';
    wizardData.prodcat = document.getElementById('wiz-prodcat')?.value || wizardData.prodcat || '';
    wizardData.designtype = document.getElementById('wiz-designtype')?.value || wizardData.designtype || '';
  }
}

function nextWizardStep() {
  captureWizardData();
  if (currentWizardStep < 4) { currentWizardStep++; refreshWizard(); }
}
function prevWizardStep() {
  if (currentWizardStep > 1) { currentWizardStep--; refreshWizard(); }
}
...
function submitForm() {
  ...
  const prefix = { patent: 'PAT', trademark: 'TM', copyright: 'COP', utility: 'UM', industrial: 'ID' };
  const refNum = `PSU-${prefix[currentFormType]}-2026-${String(submissions.length + 1).padStart(3, '0')}`;
  const newSub = {
    id: refNum, type: typeMap[currentFormType], title: 'New Research Innovation',
    applicant: 'Juan dela Cruz', department: 'College of Sciences', email: 'juan.delacruz@psu.edu.ph',
    contact: '09181234567', status: 'Pending', date: '2026-03-28', description: 'Newly submitted application.',
    paymentVerified: true, frozen: false
  };
...
function filterMarketplace() {
  ...
  document.getElementById('innovationGrid').innerHTML = filtered.length ? renderInnovationCards(filtered) : '<p style="grid-column:1/-1;text-align:center;color:var(--gray-400);padding:60px 0">No innovations found matching your criteria.</p>';
}
...
function exportCSV() {
  ...
  getVisibleAuditLogs(currentRole).forEach(l => { csv += `"${l.timestamp}","${l.user}","${l.action}","${l.module}","${l.detail}","${l.ip}"\n`; });
...
function getTrackingSteps(status) {
  const stepOrder = ['Submitted', 'Payment Verified', 'Under Review', 'Forwarded to IPOPHL', 'Registered'];
  const statusMap = {
    'Pending': 0, 'Awaiting Documents': 0, 'Under Review': 2, 'Approved': 4, 'Rejected': -1, 'Archived': -1
  };
  const activeIdx = statusMap[status] ?? 0;
  return stepOrder.map((label, i) => {
    let cls = 'pending', icon = 'fa-circle';
    if (activeIdx < 0) { cls = i === 0 ? 'completed' : 'pending'; }
    else if (i < activeIdx) { cls = 'completed'; icon = 'fa-check'; }
    else if (i === activeIdx) { cls = 'active'; icon = 'fa-circle-dot'; }
...
function renderUserSubmissions() {
  ...
  <div class="page-header">
    ...
    <p>Track the real-time status of all your intellectual property submissions.</p>
  </div>
  ${userSubmissions.length ? userSubmissions.map(s => {
    const steps = s.type === 'Copyright' ? getCopyrightTrackingSteps(s) : getTrackingSteps(s.status);
    const frozen = s.status === 'Approved';
    return `
    <div class="table-container" style="margin-bottom:20px;">
      <div class="table-header" style="cursor:pointer" onclick="this.nextElementSibling.classList.toggle('hidden')">
        <div style="display:flex; align-items:center; gap:12px;">
          ${typeBadge(s.type)} 
          <h3 style="font-size:1rem; font-weight:700; color:var(--navy); margin:0">${s.title}</h3>
          ${frozen ? '<span class="badge badge-frozen"><i class="fa-solid fa-lock"></i> Frozen for Certification</span>' : ''}
        </div>
        <div style="display:flex; align-items:center; gap:12px;">
          ${statusBadge(s.status)}
          <span style="font-size:.8rem; color:var(--gray-400)">${s.id} &bull; Filed ${s.date}</span>
          <i class="fa-solid fa-chevron-down" style="color:var(--gray-400); transition:.2s;"></i>
        </div>
      </div>
      <div style="padding:28px 28px 24px;">
        <div class="tracking-timeline">
          ${steps.map(step => `
            <div class="tracking-step ${step.cls}">
              <div class="tracking-dot"><i class="fa-solid ${step.icon}" style="font-size:.55rem"></i></div>
              <div class="tracking-label">${step.label}</div>
              ${step.cls === 'completed' ? '<div class="tracking-date"><i class="fa-solid fa-check" style="color:var(--green);font-size:.7rem;margin-right:4px"></i>Completed</div>' : ''}
              ${step.cls === 'active' ? '<div class="tracking-date" style="color:var(--gold-dark); font-weight:600;"><i class="fa-solid fa-clock" style="margin-right:4px"></i>In Progress</div>' : ''}
              ${step.cls === 'pending' ? '<div class="tracking-date">Awaiting</div>' : ''}
            </div>`).join('')}
        </div>
      </div>
    </div>`;
  }).join('') : '<div class="table-container" style="padding:32px;text-align:center;color:var(--gray-400)">No cases are linked to this client account yet.</div>'}`;
}
...
function legacyRenderAdminUsers() {
  const roleBadge = (r, u) => {
    ...
    if (r === 'specialist' || r === 'Reviewer') {
      const types = (u && u.ipTypes && u.ipTypes.length > 0) ? u.ipTypes.join(', ') : 'All IP Types';
...
function legacyEditUserRole(userId) {
  ...
  const typesOptions = ['Patent', 'Trademark', 'Copyright', 'Utility Model', 'Industrial Design'];
  let checkboxesHTML = typesOptions.map(t => 
  ...
  document.getElementById('modalTitle').textContent = 'Edit User Role & Specializations';
  document.getElementById('modalBody').innerHTML = `
...
function legacyApplyRoleChange(userId) {
  ...
  if (u) { 
    ...
    if (newRole === 'specialist') {
      const checkedBoxes = Array.from(document.querySelectorAll('.ip-type-cb:checked')).map(cb => cb.value);
      u.ipTypes = checkedBoxes;
    }
    
    closeModal(); showToast(u.name + ' settings updated!'); navigateTo('admin-users'); 
  }
}
function legacyToggleUserStatus(userId) {
  const u = systemUsers.find(x => x.id === userId);
  if (u) { u.status = u.status === 'Active' ? 'Inactive' : 'Active'; showToast(u.name + ' status changed to ' + u.status); navigateTo('admin-users'); }
}
...
function legacyRenderRolePermissions() {
  const perms = [
    { cat: 'CASE MANAGEMENT', items: [
      { action: 'View all cases', sa: '✓', pa: '✓', rv: 'Assigned', cl: 'Own only' },
      { action: 'Create / edit cases', sa: '✓', pa: '✓', rv: 'Assigned', cl: '✗' },
      { action: 'Advance stage', sa: '✓', pa: '✓', rv: '✓', cl: '✗' },
      { action: 'Delete / archive cases', sa: '✓', pa: 'Archive only', rv: '✗', cl: '✗' }
    ]},
    { cat: 'DOCUMENT VAULT', items: [
      { action: 'Upload documents', sa: '✓', pa: '✓', rv: '✓', cl: 'Own cases' },
      { action: 'Download CONFIDENTIAL', sa: '✓', pa: '✓', rv: 'Assigned', cl: '✗' },
      { action: 'Download TOP SECRET', sa: '✓', pa: 'With approval', rv: '✗', cl: '✗' }
    ]},
    { cat: 'PATENT SEARCH', items: [
      { action: 'Execute patent search', sa: '✓', pa: '✓', rv: '✓', cl: 'Limited query' },
      { action: 'View full search results', sa: '✓', pa: '✓', rv: '✓', cl: 'Public only' }
    ]},
    { cat: 'SYSTEM ADMIN', items: [
      { action: 'Manage user roles', sa: '✓', pa: 'Non-admin only', rv: '✗', cl: '✗' },
      { action: 'View audit trail', sa: '✓', pa: 'Operational only', rv: '✗', cl: '✗' },
      { action: 'System configuration', sa: '✓', pa: '✗', rv: '✗', cl: '✗' },
      { action: 'Encryption key management', sa: '✓', pa: '✗', rv: '✗', cl: '✗' }
    ]}
  ];
  const badge = v => {
    if (v === '✓') return '<span style="color:var(--green);font-size:1.1rem">✓</span>';
...
function legacyCreateNewAccount() {
  ...
  if (!name || !email || !role || !pass) { showToast('Please fill in all required fields'); return; }
  if (role !== 'Super Admin' && !dept) { showToast('Please select a department'); return; }
  
  if (pass.length < 8) { showToast('Password must be at least 8 characters'); return; }
  if (pass !== passC) { showToast('Passwords do not match'); return; }
  
  const finalDept = role === 'Super Admin' ? 'System' : dept;
  const newUser = { id: systemUsers.length + 1, name, email, role, dept: finalDept, status: 'Active', dateCreated: new Date().toISOString().split('T')[0] };
...
function editUserRole(userId) {
  ...
  const options = getManageableRoleOptions().map(role => `<option value="${role}" ${normalizeRole(user.role)===role ? 'selected' : ''}>${formatRoleLabel(role)}</option>`).join('');
...
function renderCreateAccount() {
  const roleOptions = getManageableRoleOptions().map(role => `<option value="${role}">${formatRoleLabel(role)}</option>`).join('');
...
function createNewAccount() {
  ...
  if (!name || !email || !role || !pass) { showToast('Please fill in all required fields'); return; }
  if (!getManageableRoleOptions().includes(role)) { showToast('This role cannot be created from the current account.'); return; }
  if (role !== 'superadmin' && !dept) { showToast('Please select a department'); return; }
  if (pass.length < 8) { showToast('Password must be at least 8 characters'); return; }
  if (pass !== passC) { showToast('Passwords do not match'); return; }
...
function renderRolePermissions() {
  const permissions = [
    { cat: 'CASE MANAGEMENT', items: [
      { action: 'View all cases', sa: 'check', pa: 'check', rv: 'Assigned', cl: 'Own only' },
      { action: 'Create / edit cases', sa: 'check', pa: 'check', rv: 'Assigned', cl: 'deny' },
      { action: 'Advance stage', sa: 'check', pa: 'check', rv: 'check', cl: 'deny' },
      { action: 'Delete / archive cases', sa: 'check', pa: 'Archive only', rv: 'deny', cl: 'deny' }
    ]},
    { cat: 'DOCUMENT VAULT', items: [
      { action: 'Upload documents', sa: 'check', pa: 'check', rv: 'check', cl: 'Own cases' },
      { action: 'Download CONFIDENTIAL', sa: 'check', pa: 'check', rv: 'Assigned', cl: 'deny' },
      { action: 'Download TOP SECRET', sa: 'check', pa: 'With approval', rv: 'deny', cl: 'deny' }
    ]},
    { cat: 'PATENT SEARCH', items: [
      { action: 'Execute patent search', sa: 'check', pa: 'check', rv: 'check', cl: 'Limited query' },
      { action: 'View full search results', sa: 'check', pa: 'check', rv: 'check', cl: 'Public only' }
    ]},
    { cat: 'SYSTEM ADMIN', items: [
      { action: 'Manage user roles', sa: 'check', pa: 'Non-admin only', rv: 'deny', cl: 'deny' },
      { action: 'View audit trail', sa: 'check', pa: 'Operational only', rv: 'deny', cl: 'deny' },
      { action: 'System configuration', sa: 'check', pa: 'deny', rv: 'deny', cl: 'deny' },
      { action: 'Encryption key management', sa: 'check', pa: 'deny', rv: 'deny', cl: 'deny' }
    ]}
  ];
  const badge = value => {
    if (value === 'check') return '<span style="color:var(--green);font-size:1.1rem">✓</span>';
    if (value === 'deny') return '<span style="color:var(--red);font-size:1.1rem">✕</span>';
...
function renderIpTutorial() {
  const types = [
    ...
    { id: 'copyright', icon: 'fa-copyright', color: '#10b981', gradient: 'linear-gradient(135deg,#10b981,#059669)', title: 'Copyright', subtitle: 'Safeguard creative works, software & publications', term: 'Lifetime + 50 years', requirements: ['Original work of the author', 'Fixed in tangible form', 'Creative expression (not just ideas)'], process: [{ n:1, t:'Complete the Work', d:'Ensure the work is finished and in its final form.' },{ n:2, t:'Fill Registration Form', d:'Complete PSU-IPO-CR-01 with author/creator details.' },{ n:3, t:'Upload Work & ID', d:'Submit a complete copy of the work + digitized valid ID.' },{ n:4, t:'Submit & Pay', d:'Upload proof-of-deposit for the registration fee.' },{ n:5, t:'Certificate Issuance', d:'IPOPHL issues official Certificate of Registration.' }], docs: ['Copyright Registration Form (PSU-IPO-CR-01)', 'Complete Copy of the Work', 'Valid Philippine ID (Digitized)', 'Declaration of Originality', 'Authorship Agreement (multiple authors)', 'Proof-of-Deposit / Official Receipt ⭐'] },
...
function isCopyrightFeeWaivedRoute() {
  return currentFormType === 'copyright' && wizardData.officialDuty === 'Yes' && wizardData.letterRequest === 'Approved';
}
...
function getFormGuideContent() {
  const guides = {
    ...
    utility: {
      ...
      docs: ['Utility Model Application Form', 'Technical Description', 'Technical Drawings', 'Claims Statement']
    },
    industrial: {
      ...
      docs: ['Industrial Design Application Form', 'Design Representation Files', 'Description of Design']
    }
  };
...
function renderStep3() {
  const docMap = {
    ...
    trademark: ['Trademark Application Form (PSU-IPO-TM-01)', 'Mark Specimen / Logo File (300+ DPI)', 'Description of Goods/Services', 'Declaration of First Use'],
    copyright: [
      { label: 'National Library application form (Copyright / ISSN / ISBN / ISMN)', state: 'required' },
      ...
      { label: 'Approved letter-request for official-duty works', state: 'conditional' },
      { label: 'Official Receipt / cashier receipt copy', state: 'post-review' }
    ],
    utility: ['Utility Model Application Form', 'Technical Description', 'Technical Drawings/Illustrations', 'Claims Statement', 'Novelty Statement'],
    industrial: ['Industrial Design Application Form', 'Design Representations (Photos/3D renders)', 'Description of Design', 'Product Category Statement']
  };
  ...
  const renderDocItem = (item) => {
    const entry = typeof item === 'string' ? { label: item, state: 'required' } : item;
    const badgeMap = {
      required: { label: 'Required', bg: 'rgba(22,163,74,0.08)', color: 'var(--green)' },
      conditional: { label: 'Conditional', bg: 'rgba(245,158,11,0.12)', color: '#b45309' },
      'post-review': { label: 'Post-review', bg: 'rgba(59,130,246,0.08)', color: 'var(--navy)' }
    };
  ...
  return `<h3 style="margin-bottom:24px">${isCopyright ? 'Upload Initial Copyright Packet' : 'Upload Supporting Documents'}</h3>
    ...
    ${isCopyright ? `<div style="padding:16px 18px; background:rgba(255,127,80,0.06); border:1px solid rgba(255,127,80,0.18); border-radius:12px; margin-bottom:24px;">
...
function renderStep4Review() {
  ...
  return `<h3 style="margin-bottom:24px">Review Your Application</h3>
    ...
    <div class="review-section"><h4><i class="fa-solid fa-paperclip" style="color:var(--gold);margin-right:6px"></i>Documents & Payment</h4>
      <p style="color:var(--gray-500);font-size:.9rem">${currentFormType === 'copyright'
        ? (feeWaived
        ...
        : 'Supporting documents and Proof-of-Deposit were uploaded in Step 3.'}</p>
    </div>
    ${['patent', 'trademark', 'utility', 'industrial'].includes(currentFormType) ? `<div class="review-section"><h4><i class="fa-solid fa-diagram-project" style="color:var(--gold);margin-right:6px"></i>IPOPHL Operational Route</h4>
      <div class="copyright-flow-grid">
    ...
    ${currentFormType === 'copyright' ? `<div class="review-section"><h4><i class="fa-solid fa-diagram-project" style="color:var(--gold);margin-right:6px"></i>Copyright Operational Route</h4>
      <div class="copyright-flow-grid">
        <div class="copyright-flow-card active">
          <div class="copyright-flow-meta"><span class="copyright-flow-step">Step 1-2</span><span class="copyright-stage-pill active">Queued</span></div>
          <div class="copyright-flow-title">Reviewer intake and completeness check</div>
...
function captureWizardData() {
  ...
  if (currentWizardStep === 2) {
    ...
    wizardData.marktype = document.getElementById('wiz-marktype')?.value || wizardData.marktype || '';
    wizardData.worktype = document.getElementById('wiz-worktype')?.value || wizardData.worktype || '';
    wizardData.registrationLane = document.getElementById('wiz-reglane')?.value || wizardData.registrationLane || '';
    wizardData.officialDuty = document.getElementById('wiz-officialduty')?.value || wizardData.officialDuty || '';
    wizardData.letterRequest = document.getElementById('wiz-letterrequest')?.value || wizardData.letterRequest || '';
    wizardData.originality = document.getElementById('wiz-originality')?.value || wizardData.originality || '';
    wizardData.prodcat = document.getElementById('wiz-prodcat')?.value || wizardData.prodcat || '';
    wizardData.designtype = document.getElementById('wiz-designtype')?.value || wizardData.designtype || '';
  }
}
...
function handleDepositUpload(input) {
  ...
  if (!status || !input.files.length) return;
  const f = input.files[0];
  const label = currentFormType === 'copyright' ? 'Official receipt copy uploaded' : 'Proof of Deposit uploaded';
...
function submitForm() {
  ...
  const newSub = {
    ...
    hasTopSecretAnnex: ['Patent', 'Utility Model'].includes(typeMap[currentFormType])
  };
  ...
  if (currentFormType === 'copyright') {
    ...
    newSub.officialReceiptNumber = feeWaived ? 'Fee-waived routing' : 'Pending cashier receipt';
  ...
  document.getElementById('main-content').innerHTML = `
    <div class="confirmation-screen">
      <div class="check-circle"><i class="fa-solid fa-check"></i></div>
      <h2>Application Submitted Successfully!</h2>
      <p style="color:var(--gray-500)">${currentFormType === 'copyright'
        ? (feeWaived
        ...
        : `Your ${typeMap[currentFormType]} application has been received and is now under review.`}</p>
      <div class="ref-number">${refNum}</div>
      <p style="font-size:.85rem;color:var(--gray-400);margin-bottom:24px">Please save this reference number for tracking purposes.</p>
      <div style="display:flex;gap:12px;justify-content:center">
        <button class="btn btn-primary" onclick="navigateTo('user-dashboard')"><i class="fa-solid fa-chart-line"></i> Go to Dashboard</button>
...
function renderSubmissionDetail() {
  ...
  const paymentStyles = paymentMeta.theme === 'green'
    ...
    : paymentMeta.theme === 'blue'
      ...
      : { bg: 'rgba(239,68,68,0.06)', border: 'rgba(239,68,68,0.2)', color: 'var(--red)' };
  const copyrightStage = s.type === 'Copyright' ? COPYRIGHT_OPERATION_FLOW.find(step => step.key === getCopyrightStageKey(s)) : null;
  const ipophlStageObj = IPOPHL_TYPES.has(s.type) ? IPOPHL_OPERATION_FLOW.find(step => step.key === getIPOPHLStageKey(s)) : null;
    ...
    <div class="detail-layout">
      ...
      <div>
        <div class="detail-panel">
          <h3><i class="fa-solid fa-circle-info"></i> Status</h3>
          <div style="margin-bottom:16px">${statusBadge(s.status)}</div>
          ${copyrightStage ? `<div style="padding:12px 14px; background:rgba(255,127,80,0.06); border:1px solid rgba(255,127,80,0.18); border-radius:10px; margin-bottom:16px;">
          ...
          ${ipophlStageObj ? `<div style="padding:12px 14px; background:rgba(59,130,246,0.06); border:1px solid rgba(59,130,246,0.18); border-radius:10px; margin-bottom:16px;">
        ...
        <div class="detail-panel" style="margin-top:20px">
          <h3><i class="fa-solid fa-timeline"></i> ${s.type === 'Copyright' ? 'Copyright Operational Flow' : (IPOPHL_TYPES.has(s.type) ? 'IPOPHL Operational Flow' : 'Activity Timeline')}</h3>
          ${s.type === 'Copyright' ? renderCopyrightOperationTimeline(s) : (IPOPHL_TYPES.has(s.type) ? renderIPOPHLOperationTimeline(s) : `<div class="timeline">
            ${s.status === 'Approved' ? '<div class="timeline-item"><div class="time">Mar 29, 2026 - 11:00 AM</div><div class="event"><i class="fa-solid fa-lock" style="color:#6366f1"></i> Metadata frozen for certification</div></div>' : ''}
            <div class="timeline-item"><div class="time">Mar 27, 2026 - 2:32 PM</div><div class="event">Status changed to ${s.status} by Admin Garcia</div></div>
            <div class="timeline-item"><div class="time">Mar 26, 2026 - 9:45 AM</div><div class="event"><i class="fa-solid fa-receipt" style="color:var(--gold)"></i> Proof of Deposit verified</div></div>
            <div class="timeline-item"><div class="time">Mar 25, 2026 - 10:15 AM</div><div class="event">Documents reviewed by Admin Garcia</div></div>
